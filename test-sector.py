...
datajson = {
    "sectors": [
        ...
        {"name": "Foreign Affairs", "description": "India’s foreign affairs are closely integrated with the country's fundamental security and developmental priorities."},
        {"name": "Governance And Administration", "description": "India is a Sovereign, Socialist, Secular, Democratic Republic with a Parliamentary form of government which is federal in structure with unitary features. This section provides data on Indian governance and administration at the Central, state as well as local level."},
