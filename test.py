...
token = keycloak_openid.token("abhinav@civicdatalab.in", "abcd1234") #("abhinav", "!Abcd1234@")  # ("sanjay", "abcd1234")
...
# import requests
# requests.get('https://dev.strapi.idp.civicdatalab.in/uploads/download_1_e985269089.png', verify=False)
